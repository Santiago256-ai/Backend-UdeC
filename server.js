...
// ⚡ Importar la nueva ruta de mensajes ⚡
...
app.use('/api/mensajes', mensajesRoutes); // Esto expone POST /api/mensajes/empresa
...
app.get('/', (req, res) => {
    res.json({ 
        ...
        endpoints: {
            ...
            test: '/api/test',
            // ⚡ Nueva ruta documentada
            mensajes: {
                enviarEmpresa: 'POST /api/mensajes/empresa' 
            }
        }
    });
});
